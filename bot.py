...
# YouTube Logic (แก้ให้รองรับ m4a + Safari)
...
def download_youtube_audio(url: str, output_path: str) -> bool:
    try:
        import yt_dlp
        opts = get_ydl_opts()
        # เปลี่ยนจาก bestaudio/best เป็น m4a ก่อน (แก้ Error format not available)
...
@queue_group.command(name="add", description="เพิ่ม URL ลงคิว")
